...
jotka voivat jäädä viemään levytilaa tai estämään ohjelman käynnistämisen,
mikäli ohjelma käyttää lukkotiedostoa estämään useamman ohjelmainstanssin käynnistämisen.
